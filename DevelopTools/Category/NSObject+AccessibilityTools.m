...
//- (AFHTTPRequestOperationManager *)customManagerForHTTPHeader
//{
//    AFHTTPRequestOperationManager *manager = [AFHTTPRequestOperationManager manager];
//    [manager.requestSerializer setValue:[Helper triple3DES:@"www.hongmaofalv.com" desKey:@"hongmaofalvfly4000041200" encryptOrDecrypt:kCCEncrypt] forHTTPHeaderField:@"hmfl"];
//    return manager;
//}
...
{
    return [[AFHTTPSessionManager manager] GET:[self customInterface:interfaceName] parameters:parameter progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
...
{
    return [[AFHTTPSessionManager manager] POST:[self customInterface:interfaceName] parameters:parameter progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        success ? success(task, responseObject) : nil;
    } failure:^(NSURLSessionDataTask * _Nullable task, NSError * _Nonnull error) {
